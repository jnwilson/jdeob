...
const GENERATOR = {
  ...
  */
  ...
  ImportDeclaration(node, state) {
    ...
    const {
      length
    } = specifiers; // NOTE: Once babili is fixed, put this after condition
...
class State {
  constructor(options) {
    ...
    this.expressionsPrecedence = setup.expressionsPrecedence != null ? setup.expressionsPrecedence : EXPRESSIONS_PRECEDENCE; // Formating setup
...
function generate(node, options) {
  ...
  */
  const state = new State(options); // Travel through the AST node and generate the code
